...
export class ItemCard extends Component {
    ...
    render() {
        ...
        return (
            <div className='flex w-400 items-center border flex-row flex-wrap shadow-xl gap-1 min-h-200 font-tnr hover:bg-gradient-to-b from-orange-100 to-ct4-orange  rounded-lg' onClick={this.handlePopup}>
                <div className='mx-2'>
